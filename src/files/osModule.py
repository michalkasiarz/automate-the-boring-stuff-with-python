...
print("Relative path: " + str(
    os.path.relpath(r"..\\..\\folder1\\folder2\\file1.png", r"c:\\folder1")))  # Relative path: folder2\file1.png

# gives last directory from a path
print("Last directory: " + str(
    os.path.dirname(r"C:\\folder1\\folder2\\file1.png")))  # Last directory: C:\\folder1\\folder2
...
try:
    os.makedirs(r"C:\Users\micha\Documents\Training\new_folder_here\and_here_another_one")
except FileExistsError:
    print("FileExistsError, mate! It's is already done!")
